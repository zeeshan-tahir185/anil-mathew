    ...
    <div className='bg-[#F7F4F1]'>
      ...
      <div className='bg-[#111111]/5 w-full mb-[50px] lg:mb-[150px]'>
        <div className=' flex flex-col gap-6 items-center justify-center py-[52px] lg:py-[83px]  px-4 md:px-[50px] lg:px-0 w-full text-center lg:w-[800px] mx-auto '>
          <h2 className='font-charter text-[36px] lg:text-[64px] leading-[36px] lg:leading-[64px] text-[#1A1A1A] '>You’ve reached a place that doesn’t exist.</h2>
          ...
          <div className='flex items-center gap-4 lg:gap-8 justify-center'>
            ...
            <Link href="#" className='font-inter font-medium text-xs lg:text-sm underline text-[#111111] uppercase'>About</Link>
            <span className='h-[16px] border border-[#111111] opacity-25 '></span>
            <Link href="#" className='font-inter font-medium text-xs lg:text-sm underline text-[#111111] uppercase'>Press</Link>
            <span className='h-[16px] border border-[#111111] opacity-25 '></span>
            <Link href="#" className='font-inter font-medium text-xs lg:text-sm underline text-[#111111] uppercase'>Ventures</Link>
          </div>
