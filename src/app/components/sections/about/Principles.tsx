...
const Principles = () => {
    ...
    return (
        <div className='bg-[#E8DCCB]'>
            <div className='flex flex-col items-center text-center  justify-center gap-[50px] lg:gap-[160px] py-[50px] lg:py-[130px] px-4 md:px-[50px] xl:px-[100px] 2xl:px-[160px] max-w-[1920px] mx-auto'>
                ...
                <div className='hidden md:flex flex-wrap justify-center items-center gap-4 lg:gap-6'>
                    {items.map((item, i) => (
                        <div key={i} className='flex flex-col justify-center p-2 lg:p-3 gap- lg:gap-8 items-center text-center w-[280px] 2xl:w-[382px] bg-[#1A1A1A0D] min-h-[250px] lg:min-h-[306px] rounded-xl lg:rounded-[24px] border border-[#E8DCCB26]'>
