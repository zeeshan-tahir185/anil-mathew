...
const OffTheClock = () => {
    return (
        <div className='bg-[#1A1A1A]'>
            <div className='flex flex-col items-center text-center  justify-center gap-[30px] lg:gap-[50px] py-[50px] lg:py-[130px] px-4 md:px-[50px] xl:px-[100px] 2xl:px-[297px] max-w-[1920px] mx-auto'>
                <div className='flex flex-col gap-6 lg:gap-8 items-center text-center w-full lg:w-[553px]'>
