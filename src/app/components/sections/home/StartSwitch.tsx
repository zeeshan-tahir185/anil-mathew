    ...
    return (
        <div className='bg-[#E8DCCB] '>
            <div className='flex flex-col xl:flex-row gap-6 lg:gap-[80px] px-4 md:px-[50px] xl:px-[100px] xl:pr-0! 2xl:px-[130px] pt-[60px] lg:pt-[150px] items-center vision_section_padding max-w-[1920px] mx-auto'>
                <div className='flex flex-col gap-6 lg:gap-10 lg:mb-[70px] 2xl:gap-16 w-full xl:w-[600px] 2xl:w-[713px] items-center lg:items-start text-center lg:text-left'>
                    ...
                    <div className='w-full gap-4 flex flex-col lg:flex-row '>
                       <Link href="https://www.thestartswitch.com" target='_blank' rel="noopener">
                        <button className="cursor-pointer mx-auto md:mx-0 w-full lg:w-[170px] 2xl:w-[199px] bg-[#1A3470] text-[#E8DCCB] h-[46px] backdrop-blur-[25px] flex justify-center items-center gap-2 rounded-full uppercase text-sm 2xl:text-base font-inter font-medium ">
                        ...
                        <button className="cursor-pointer mx-auto md:mx-0 w-full lg:w-[185px] 2xl:w-[207px] bg-[#E8DCCB03] backdrop-blur-[25px] border border-[#11141826] flex justify-center items-center gap-2 text-[#111111] h-[46px] rounded-full uppercase text-sm 2xl:text-base font-inter font-medium ">
                        ...
                        <Link href="https://www.goodreads.com/author/show/57597604.Anil_Mathews" target="_blank" rel="nofollow noopener">
                            <button className="cursor-pointer mx-auto md:mx-0 w-full lg:w-[250px] 2xl:w-[275px] bg-[#E8DCCB03] backdrop-blur-[25px] border border-[#11141826] flex justify-center items-center gap-2 text-[#111111] h-[46px] rounded-full uppercase text-sm 2xl:text-base font-inter font-medium ">
                ...
                <Image src="/images/home/starts_mob.png" alt='starts image' width={298} height={420} className='xl:hidden block w-[90%] mx-auto mt-[10px]' />
            </div>
        </div>
    )
}
