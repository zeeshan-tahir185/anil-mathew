    ...
    return (
       <div className='bg-[#0D0F13]'>
         <div className='max-w-[1920px] mx-auto w-full py-[55px] lg:py-[180px] px-4 lg:px-[80px] xl:px-[120px] 2xl:px-[150px] ventures_prev_main flex flex-col gap-6'>
            ...
            <div className='flex flex-col lg:flex-row lg:flex-row gap-6'>
                <div className='lg:p-[50px] p-[15px] flex flex-col gap-[32px] lg:gap-[120px] w-full lg:w-[500px] xl:w-[50%] border border-[#E8DCCB26] rounded-[24px]'>
                    <div className='flex flex-col gap-4'>
                        <h3 className='text-[24px] lg:text-[32px] font-charter text-[#F7F4F1]'>Near Intelligence</h3>
                        <p className='text-base lg:text-xl font-inter text-[#F7F4F1] opacity-65'>Founder and CEO through its Nasdaq listing.
                            Built one of the world’s leading data intelligence platforms with operations across four continents.
                        </p>
                        <p className='text-base lg:text-xl font-inter mt-4 text-[#F7F4F1] opacity-65'>Work included global expansion, product scaling, and strategic acquisitions such as Teemo in Paris and UM in California to strengthen product and data capabilities.
                        </p>
                    </div>
                ...
                <div className='flex flex-col gap-4 w-full lg:w-[500px] xl:w-[50%]'>
                    <div className='flex flex-col gap-[60px] p-[15px] lg:p-[45px] border border-[#E8DCCB40] rounded-[24px]'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <h3 className='text-[24px] lg:text-[32px] font-charter text-[#F7F4F1]'>Imere Tech</h3>
                             <p className='text-base lg:text-xl font-inter text-[#F7F4F1] opacity-65'>Early leadership focused on product and operations in emerging markets. Helped teams translate market data into practical execution.
                        </p>
                        </div>
                    </div>
                    <div className='flex flex-col gap-[60px] p-[15px] lg:p-[45px] border border-[#E8DCCB40] rounded-[24px]'>
                        ...
                        <div className='flex flex-col gap-4'>
                            <h3 className='text-[24px] lg:text-[32px] font-charter text-[#F7F4F1]'>Netkode Solutions</h3>
                             <p className='text-base lg:text-xl font-inter text-[#F7F4F1] opacity-65'>Early-stage engineering venture focused on delivery systems and customer development. Taught the fundamentals of building, shipping, and selling fast.
                        </p>
                        </div>
                    </div>
