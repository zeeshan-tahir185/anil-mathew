    ...
    return (
        <div className='px-4 max-w-[1920px] mx-auto py-[35px] lg:py-[90px] w-full xl:w-[1100px] flex flex-col gap-[30px] lg:gap-[70px]'>
            <div className='flex flex-col gap-[20px] lg:gap-[30px] text-left'>
                ...
                <p className='text-[#111111] opacity-65 font-inter text-base lg:text-xl'>Anil Mathews joined hosts Julian Klymochko and Michael Kesslering on the Absolute Return Podcast for episode #231, published September 19, 2022. The conversation covers the make-up of successful founders, what makes enterprise software compelling to build, and practical uses of Near’s datasets.</p>
            </div>
            <div className='flex flex-col gap-[20px] lg:gap-[25px] '>
                <h3 className='font-charter text-xl lg:text-[32px] text-[#1A1A1A] '>Key notes</h3>
                <div className='flex flex-col gap-2 lg:gap-4  '>
                    <div className=' flex gap-2 lg:gap-4 items-start md:items-center'>
                        <Image src="/images/interviews/icon.png" width={31} height={30} alt='interview image' />
                        <p className='text-base lg:text-xl font-inter text-[#111111] '>Are entrepreneurs born or made.</p>
                    </div>
                    <div className=' flex gap-2 lg:gap-4 items-start md:items-center'>
                        <Image src="/images/interviews/icon.png" width={31} height={30} alt='interview image' />
                        <p className='text-base lg:text-xl font-inter text-[#111111] '>What characteristics make enterprise software attractive for builders and operators.</p>
                    </div>
                    <div className=' flex gap-2 lg:gap-4 items-start md:items-center'>
                        <Image src="/images/interviews/icon.png" width={31} height={30} alt='interview image' />
                        <p className='text-base lg:text-xl font-inter text-[#111111] '>How Near’s people-, place-, and product-level datasets are used by customers.</p>
                    </div>
                    <div className=' flex gap-2 lg:gap-4 items-start md:items-center'>
                        <Image src="/images/interviews/icon.png" width={31} height={30} alt='interview image' />
                        <p className='text-base lg:text-xl font-inter text-[#111111] '>The most important attribute an entrepreneur needs, according to Anil.</p>
                    </div>
                </div>
